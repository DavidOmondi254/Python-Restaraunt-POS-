...
root.title('Restaurant Management System created by David Nyalwal')
...
labelTitle=Label(topFrame,text='Restaurant Management System',font=('arial',30,'bold'),fg='white',bd=9,
                 bg='red4',width=51)
...
frenchfries=Checkbutton(foodFrame,text='frenchfries',font=('arial',18,'bold'),onvalue=1,offvalue=0,variable=var1
                 ,command=roti)
frenchfries.grid(row=0,column=0,sticky=W)

samosa=Checkbutton(foodFrame,text='samosa',font=('arial',18,'bold'),onvalue=1,offvalue=0,variable=var2
                 ,command=daal)
...
bhajia=Checkbutton(foodFrame,text='bhajia',font=('arial',18,'bold'),onvalue=1,offvalue=0,variable=var4
                  ,command=sabji)
bhajia.grid(row=3,column=0,sticky=W)
...
mahamri=Checkbutton(foodFrame,text='mahamri',font=('arial',18,'bold'),onvalue=1,offvalue=0,variable=var6
                   ,command=chawal)
mahamri.grid(row=5,column=0,sticky=W)
